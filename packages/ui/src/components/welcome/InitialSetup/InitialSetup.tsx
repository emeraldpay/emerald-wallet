...
class InitialSetup extends React.Component<Props> {
  ...
  render() {
    const {
      terms, onTermsAgreed, connectXSM, connectETH, connectETC, currentTermsVersion,
    } = this.props;
    ...
    if (terms !== currentTermsVersion) {
      ...
      activeStep = 1;
      step = <OpenWallet connectXSM={connectXSM} connectETC={connectETC} connectETH={connectETH}/>;
    }
