...
describe('Balance', () => {
  ...
  test('get balance for a new xpub', async () => {
    ...
    const act = await manager.balances.list("zpub6sozJoQ5h3nRweiYhN8XxW5c61vMzTAy4tSJ6AiVbJ1X4CxEJPZx9EhexbY64oWfLyzuMoY62xnLJJZT7H3LQJji66vhrH2nuFT5TFp3vjN");
  ...
  test('get balance for known xpub', async () => {
    ...
    let xpub = "zpub6sozJoQ5h3nRweiYhN8XxW5c61vMzTAy4tSJ6AiVbJ1X4CxEJPZx9EhexbY64oWfLyzuMoY62xnLJJZT7H3LQJji66vhrH2nuFT5TFp3vjN"
    await manager.balances.set({
      amount: "123456",
