...
describe('registry', () => {
  it('should find by symbol', () => {
    const token = registry.byTokenSymbol(BlockchainCode.ETH, 'USDT');
  ...
  it('should find by token address', () => {
    const token = registry.byTokenAddress(BlockchainCode.ETH, '0x6B175474E89094C44Da98b954EedeAC495271d0F');
