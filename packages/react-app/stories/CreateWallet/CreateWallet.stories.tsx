...
export const Empty = () => <CreateWalletWizard seeds={[]} blockchains={blockchains} {...handlers} />;
...
export const UnlockingSeed = () => <UnlockSeed seedId="6aacf568-ec33-435f-b234-3668534a7f13" onUnlock={action('unlock')} />;
