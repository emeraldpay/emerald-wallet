...
import {fiatCurrency} from "@emeraldwallet/store/lib/settings/selectors";
    ...
    getState() {
      return {
        ...
        [accounts.moduleName]: {
          ...
          details: [
            {accountId: 'f692dcb6-74ea-4583-8ad3-fd13bb6c38ee-0', balance: new Wei(1000000000000000).encode()},
            {accountId: 'f692dcb6-74ea-4583-8ad3-fd13bb6c38ee-1', balance: new Wei(0).encode()},
            {accountId: 'f692dcb6-74ea-4583-8ad3-fd13bb6c38ee-2', balance: new Wei(0).encode()},
            {accountId: 'c0659f31-1932-4006-bc4c-dbbab27fc25c-0', balance: new Wei(2000000000000000).encode()},
            {accountId: 'c0659f31-1932-4006-bc4c-dbbab27fc25c-1', balance: new Wei(3000000000000000).encode()}
          ]
        }
      };
    }
...
describe('Header/Total', () => {
  it('renders total balance from store', () => {
    ...
    // 0.70368 + 0.02367
    // = 0.72735
    expect(component.find(Total).children().first().props().total).toEqual(new CurrencyAmount('0.72735', "USD"));
  });
});
