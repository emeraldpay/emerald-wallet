...
describe('CreateErc20Tx', () => {
  ...
  it('creates tx', () => {
    const tx = new CreateErc20Tx('0x6B175474E89094C44Da98b954EedeAC495271d0F', tokenRegistry, BlockchainCode.ETH);
  ...
  it('reads from dumps', () => {
    ...
    const tx = CreateErc20Tx.fromPlain(dump, tokenRegistry);
