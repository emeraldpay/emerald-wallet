                ...
                <div style={formStyles.right}>
                    <div>
                        ...
                        <div className={ styles.description }>
                            You need an Account File to make all operations with account. When you want to view your balance or send something from your Ethereum Classic Account, you will need this file.  You will also need the strong password you created earlier.
                        </div>
                    </div>
                </div>
            </Row>
            ...
            <Row>
                ...
                <div style={formStyles.right}>
                    <Warning>
                        ...
                        <WarningText>If someone get your account file, he can get full access to your account and funds.</WarningText>
